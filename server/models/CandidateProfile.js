...
candidateProfileSchema.index({
  "skillsAndCertifications.technicalSkills.skillName": 1,
});
...
candidateProfileSchema.pre("save", function (next) {
  ...
  // Education (20%)
  if (
    this.educationHistory.graduation.degree ||
    this.educationHistory.tenthGrade.percentage
  ) {
    completeness += 20;
  }
  ...
  // Skills (15%)
  if (
    this.skillsAndCertifications.technicalSkills &&
    this.skillsAndCertifications.technicalSkills.length > 0
  ) {
    completeness += 15;
  }
