...
export default function JobsPage() {
  ...
  const handleUpdateJob = async (jobData) => {
    try {
      ...
      if (data.success) {
        ...
        setMessage({
          type: "error",
          text: data.error || "Failed to update job",
        });
      }
    } catch (error) {
  ...
  const updateApplicationStatus = async (
    ...
    try {
      const response = await apiCall(
        `/api/admin/applications/${applicationId}/${getActionFromStatus(newStatus)}`,
        {
          method: "PUT",
  ...
  const MultiSelectDropdown = ({
    ...
    return (
      <div className="relative">
        ...
        >
          <span
            className={selected.length > 0 ? "text-white" : "text-gray-400"}
          >
            ...
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              ...
              <div>
                ...
                <MultiSelectDropdown
                  ...
                  onChange={(selected) =>
                    setFormData((prev) => ({ ...prev, benefits: selected }))
                  }
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-400">
                {applicationsData.length} applicant
                {applicationsData.length !== 1 ? "s" : ""} found
              </p>
            </div>
            <button
          ...
          <div className="space-y-6">
            {applicationsData.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h4 className="text-3xl font-bold text-gray-400 mb-4">
                  No Applications Yet
                </h4>
                ...
                >
                  <div className="flex items-start justify-between mb-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4 text-sm text-gray-400">
                          ...
                          <span className="flex items-center space-x-1">
                            <span>📍</span>
                            <span>
                              {application.applicant?.profile?.address?.city ||
                          ...
                          <span className="flex items-center space-x-1">
                            ...
                            <span>
                              {application.applicant?.profile
                                ?.totalExperience || "Experience not specified"}
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col items-end space-y-3">
                      <div
                        className={`px-4 py-2 rounded-full text-sm font-medium text-white ${getApplicationStatusColor(application.status)}`}
                      >
  ...
  const JobCard = ({ job }) => (
    <div
      className={`group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border-l-4 ${getUrgencyColor(job.urgency)} border border-white/20 hover:border-white/40`}
    >
      {/* Header */}
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex items-center space-x-3">
          <div
            className={`px-4 py-2 rounded-full text-sm font-medium text-white ${getStatusColor(job.status)}`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="flex items-center space-x-3 p-4 bg-white/5 rounded-xl border border-white/10">
          ...
          <div>
            <div className="font-semibold text-white">
              {getNoticePeriodDisplay(job.noticePeriod)}
            </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {job.skills.slice(0, 8).map((skill, index) => (
              <span
                key={index}
                className="px-3 py-1 bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-purple-300 text-sm rounded-lg border border-purple-500/30"
              >
                {skill}
              </span>
            ))}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto font-light">
            Create, manage, and track your job postings with advanced analytics
            and modern features
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-12">
          ...
          <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 backdrop-blur-md rounded-3xl p-6 text-center shadow-lg border border-yellow-500/30">
            ...
            <div className="text-3xl font-bold mb-1 text-yellow-400">
              {jobs.reduce((sum, job) => sum + (job.shortlisted || 0), 0)}
            </div>
          ...
          <div className="bg-gradient-to-br from-red-500/20 to-red-600/20 backdrop-blur-md rounded-3xl p-6 text-center shadow-lg border border-red-500/30">
            ...
            <div className="text-3xl font-bold mb-1 text-red-400">
              {
                jobs.filter(
                  (j) => j.urgency === "critical" || j.urgency === "high",
                ).length
              }
            </div>
